...
if (hasInterface) then {
    ...
    ["<t size='1.0' color='#7A0A0A'>The Woman Who Disappeared<t font = 'puristaLight' <t size='0.5' color='#FFFFFF'>v1.0<t font = 'puristaLight' t size='1.0' color='#FFFFFF'> Desenvolvida por <br/><t font = 'puristaLight t size='0.6' color='#FFFFFF'>Collumbus [AEGIS]</t>",0,0.2,3,1,0.0] spawn bis_fnc_dynamictext;
    ...
    CamDestroy _cam;
     ...
     [str ("AEGIS"), str(date select 1) + "." + str(date select 2) + "." + str(date select 0), str("Costa de Stratis")] call BIS_fnc_infoText;
